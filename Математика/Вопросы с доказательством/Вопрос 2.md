...
и дифференцируема в ней. Пусть полное приращение функции в точке $M_0$ представимо в виде: $$\Delta{z} = A*\Delta{x} + B*\Delta{y} + \alpha(x_0, y_0)*p$$где $p = \sqrt{\Delta{x}^2 + \Delta{y}^2}$ и $\lim_{p \to 0}\alpha(\Delta{x}, \Delta{y}) = 0$
...
По условию функция $z = f(x,y)$ дифференцируема в точке $M_0$ следовательно ее полное приращение в точке $M_0$ имеет вид: $$\Delta{z} = f(x_0+\Delta{x},y_0+\Delta{y}) - f(x_0,y_0)$$ Таким образом для достаточно малых $\Delta{x}$ и $\Delta{y}$: $$f(x_0+\Delta{x},y_0+\Delta{y}) - f(x_0,y_0) = A*\Delta{x} + B*\Delta{y} + \alpha(x_0, y_0)*p$$
